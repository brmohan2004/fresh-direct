...
import { User, Mail, Phone, Lock, Eye, EyeOff, Leaf, Users, Truck, ChevronLeft } from 'lucide-react';
import heroImg from '../../../assets/image.png';

/**
 * SignupPage Component
 * Perfectly matching the desktop & mobile reference screenshots provided:
 * - Desktop: Dual-column grid for Full Name & Email Address + Phone Number + Password & Confirm Password with icons.
 * - Mobile: Single column full rounded sheet with top farm hero banner, back button, Terms checkbox, Sign Up CTA, and social buttons.
 */
export default function SignupPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Redirect to login or mode selection after sign up
    navigate('/auth/login');
  };
  ...
  return (
    <div className="auth-page-container">
      ...
      {/* Form Pane (Sign Up Form matching design exact) */}
      <div className="auth-form-pane">
        <div className="auth-form-card signup-card-wide">
          <div className="auth-card-header">
            <h2>Create Your Account</h2>
            <p>Join us and enjoy fresh produce from farms</p>
          </div>
